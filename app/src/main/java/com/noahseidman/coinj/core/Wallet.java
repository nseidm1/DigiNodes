...
import com.noahseidman.coinj.signers.LocalTransactionSigner;
import com.noahseidman.coinj.signers.MissingSigResolutionSigner;
import com.noahseidman.coinj.signers.TransactionSigner;
import com.noahseidman.coinj.store.UnreadableWalletException;
import com.noahseidman.coinj.store.WalletProtobufSerializer;
import com.noahseidman.coinj.utils.BaseTaggableObject;
import com.noahseidman.coinj.utils.ExchangeRate;
import com.noahseidman.coinj.utils.ListenerRegistration;
import com.noahseidman.coinj.utils.Threading;
import com.noahseidman.coinj.wallet.*;
import com.noahseidman.coinj.wallet.Protos.Wallet.EncryptionType;
import com.noahseidman.coinj.wallet.WalletTransaction.Pool;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.noahseidman.coinj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject implements Serializable, BlockChainListener, PeerFilterProvider, KeyBag, TransactionBag {
     ...
     * {@link com.noahseidman.coinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(com.noahseidman.coinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.noahseidman.coinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(com.noahseidman.coinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(com.noahseidman.coinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.noahseidman.coinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link com.noahseidman.coinj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link com.noahseidman.coinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(com.noahseidman.coinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.noahseidman.coinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(com.noahseidman.coinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(com.noahseidman.coinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.noahseidman.coinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.noahseidman.coinj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link com.noahseidman.coinj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link com.noahseidman.coinj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link com.noahseidman.coinj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws com.noahseidman.coinj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.noahseidman.coinj.crypto.KeyCrypter,
     ...
     * {@link com.noahseidman.coinj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link com.noahseidman.coinj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link com.noahseidman.coinj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link com.noahseidman.coinj.signers.TransactionSigner.MissingSignatureException}
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link com.noahseidman.coinj.core.Wallet#getBalance()} - the fees required
        ...
        /**
         * If not null, the {@link com.noahseidman.coinj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
     ...
     */
    public void setTransactionBroadcaster(@Nullable com.noahseidman.coinj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws com.noahseidman.coinj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
     ...
     * {@link com.noahseidman.coinj.core.PeerFilterProvider} interface and generally should not be used directly by apps.
