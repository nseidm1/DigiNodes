...
import static com.noahseidman.coinj.core.Utils.*;
...
public class Transaction extends ChildMessage implements Serializable {
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.noahseidman.coinj.script.Script, ECKey, com.noahseidman.coinj.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.noahseidman.coinj.core.Transaction.SigHash, boolean)}
