...
import com.noahseidman.coinj.wallet.KeyChainEventListener;
...
public interface WalletEventListener extends KeyChainEventListener {
     ...
     * the object retrieved via {@link com.noahseidman.coinj.core.Transaction#getConfidence()}. It's safe to modify the
