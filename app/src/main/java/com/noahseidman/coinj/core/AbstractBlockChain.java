 ...
 * the lightweight SPV mode, a {@link com.noahseidman.coinj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link com.noahseidman.coinj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
