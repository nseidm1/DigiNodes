...
import com.noahseidman.coinj.crypto.NativeSecp256k1;
...
public class ECKey implements EncryptableItem, Serializable {
     ...
     * usually encoded using DER format, so you want {@link com.noahseidman.coinj.core.ECKey.ECDSASignature#toASN1()}
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Peercoin protocol, they are
     * usually encoded using DER format, so you want {@link com.noahseidman.coinj.core.ECKey.ECDSASignature#encodeToDER()}
     ...
     * the {@link com.noahseidman.coinj.core.DumpedPrivateKey#toString()} method to get the string.
     *
