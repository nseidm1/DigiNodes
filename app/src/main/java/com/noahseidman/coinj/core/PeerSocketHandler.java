...
import com.noahseidman.coinj.net.MessageWriteTarget;
import com.noahseidman.coinj.net.StreamParser;
 ...
 * {@link com.noahseidman.coinj.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamParser {
     ...
     * called automatically by {@link com.noahseidman.coinj.net.NioClient} or
     * {@link com.noahseidman.coinj.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
