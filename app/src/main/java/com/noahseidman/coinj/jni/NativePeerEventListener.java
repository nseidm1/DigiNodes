...
package com.noahseidman.coinj.jni;
...
public class NativePeerEventListener implements PeerEventListener {
    ...
    @Override
    public native void onPeerConnected(Peer peer);

    @Override
    public native void onPeerDisconnected(Peer peer);
    ...
    @Override
    public void onDnsDiscovery(InetSocketAddress[] addresses) {

    }

    @Override
    public void onPeersDiscovered(Peer peer, List<PeerAddress> addresses) {
