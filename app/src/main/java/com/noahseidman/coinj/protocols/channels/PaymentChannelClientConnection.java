...
import com.noahseidman.coinj.net.NioClient;
import com.noahseidman.coinj.net.ProtobufParser;
...
public class PaymentChannelClientConnection {
     ...
     * connection is open. The server is requested to keep the channel open for {@link com.noahseidman.coinj.protocols.channels.PaymentChannelClient#DEFAULT_TIME_WINDOW}
