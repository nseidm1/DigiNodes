...
import com.noahseidman.coinj.wallet.AllowUnconfirmedCoinSelector;
...
public class PaymentChannelClientState {
     ...
     * overriding {@link PaymentChannelClientState#editContractSendRequest(com.noahseidman.coinj.core.Wallet.SendRequest)}.
