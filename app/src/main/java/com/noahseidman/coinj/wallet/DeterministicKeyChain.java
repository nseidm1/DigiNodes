...
import com.noahseidman.coinj.core.BloomFilter;
import com.noahseidman.coinj.core.ECKey;
import com.noahseidman.coinj.core.Utils;
 ...
 * {@link com.noahseidman.coinj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link com.noahseidman.coinj.crypto.MnemonicCode},
 ...
 * {@link com.noahseidman.coinj.crypto.DeterministicKey#serializePubB58()}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link com.noahseidman.coinj.crypto.DeterministicKey#deserializeB58(com.noahseidman.coinj.crypto.DeterministicKey, String)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(com.noahseidman.coinj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link com.noahseidman.coinj.crypto.DeterministicHierarchy} and
 * {@link com.noahseidman.coinj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
     ...
     * The returned key can be serialized and then passed into {@link #watch(com.noahseidman.coinj.crypto.DeterministicKey)}
