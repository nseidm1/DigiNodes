...
import com.noahseidman.coinj.crypto.KeyCrypterException;
...
public interface EncryptableKeyChain extends KeyChain {
     ...
     * {@link #toEncrypted(com.noahseidman.coinj.crypto.KeyCrypter, org.spongycastle.crypto.params.KeyParameter)} with
     * {@link com.noahseidman.coinj.crypto.KeyCrypterScrypt} as the crypter.
     *
     ...
     * {@link com.noahseidman.coinj.core.Wallet.SendRequest#aesKey} field before asking the wallet to build the send.
     *
