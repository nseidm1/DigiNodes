...
import com.noahseidman.coinj.crypto.ChildNumber;
import com.noahseidman.coinj.crypto.DeterministicKey;
import com.noahseidman.coinj.crypto.KeyCrypter;
...
/**
 * <p>A KeyChainGroup is used by the {@link com.noahseidman.coinj.core.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws com.noahseidman.coinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link com.noahseidman.coinj.crypto.KeyCrypterScrypt}.
     *
     * @throws com.noahseidman.coinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
