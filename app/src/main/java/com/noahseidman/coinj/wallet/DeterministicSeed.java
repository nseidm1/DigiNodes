...
public class DeterministicSeed implements EncryptableItem {
    ...
    /**
     * Constructs a seed from a BIP 39 mnemonic code. See {@link com.noahseidman.coinj.crypto.MnemonicCode} for more
     ...
     *
     * @throws com.noahseidman.coinj.crypto.MnemonicException if check fails
     */
